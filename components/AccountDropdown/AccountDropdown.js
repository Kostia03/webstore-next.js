...
import AccountIcon from 'public/images/ic_account.svg';
  ...
  return (
    <Fragment>
      { isAuthenticated ?
        ...
        :
        <IconButton color="inherit" onClick={toggleOpen} className={classes.iconbutton}>
          <SvgIcon component={AccountIcon} viewBox="0 0 19 20" className={classes.innerIcon} />
        </IconButton>
      }
