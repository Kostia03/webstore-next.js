...
import headerStyle from 'components/Header/header-jss';
import CartIcon from 'public/images/ic_cart.svg';
          ...
          >
            {(cart && cart.totalItemQuantity > 0)
              ? (
                ...
                >
                  <SvgIcon component={CartIcon} viewBox="0 0 21 18" className={classes.innerIcon} />
                </Badge>
              )
              : <SvgIcon component={CartIcon} viewBox="0 0 21 18" className={classes.innerIcon} />
            }
